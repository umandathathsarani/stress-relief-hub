...
class Hub {
    ...
    launchGame(gameId) {
        ...
        if (gameId === 'bubble-wrap') this.activeGameInstance = new BubbleWrap('active-game');
        else if (gameId === 'zen-garden') this.activeGameInstance = new ZenGarden('active-game');
        else if (gameId === 'zen-slicer') this.activeGameInstance = new ZenSlicer('active-game');
        else if (gameId === 'kinetic-sand') this.activeGameInstance = new KineticSand('active-game');
        else if (gameId === 'domino-topple') this.activeGameInstance = new DominoTopple('active-game');
        else if (gameId === 'spin-art') this.activeGameInstance = new SpinArt('active-game');
        else if (gameId === 'lofi-keyboard') this.activeGameInstance = new LofiKeyboard('active-game');
        else if (gameId === 'water-ripples') this.activeGameInstance = new WaterRipples('active-game');
